...
public class MenuSwing {
    ...
    public void startMenu() {
        ...
        // Creazione dei bottoni per nuova partita, carica partita, aiuto ed esci dal gioco
        ...
        helpButton.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.BLACK));
        ...
        frame.add(sfondo); // Add sfondo al frame
